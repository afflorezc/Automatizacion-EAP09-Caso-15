...
public class ConsultAvailabilityEnterThe implements Task {
    ...
    public static ConsultAvailabilityEnterThe forDate(String date) {
        return Tasks.instrumented(ConsultAvailabilityEnterThe.class, date);
    }
}